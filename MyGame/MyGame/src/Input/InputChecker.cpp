...
{
	//各種キーの関連付け
	inputList_[Input_Key::A] = Connect_Key_Pad(KEYCODE::M, PADBUTTON::NUM1);
	inputList_[Input_Key::B] = Connect_Key_Pad(KEYCODE::K, PADBUTTON::NUM2);
	inputList_[Input_Key::X] = Connect_Key_Pad(KEYCODE::N, PADBUTTON::NUM3);
	inputList_[Input_Key::Y] = Connect_Key_Pad(KEYCODE::Z, PADBUTTON::NUM4);
	inputList_[Input_Key::R1] = Connect_Key_Pad(KEYCODE::O, PADBUTTON::NUM6);
	inputList_[Input_Key::L1] = Connect_Key_Pad(KEYCODE::U, PADBUTTON::NUM5);
