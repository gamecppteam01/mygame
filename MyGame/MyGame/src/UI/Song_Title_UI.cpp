...
{
	songMap_[Sound::GetInstance().GetHandle(BGM_ID::STAGE1_BGM)] = "ワルツ";
	songMap_[Sound::GetInstance().GetHandle(BGM_ID::STAGE2_BGM)] = "ハロウィンパレード";
	songMap_[Sound::GetInstance().GetHandle(BGM_ID::STAGE3_BGM)] = "亡魂舞踏曲";
}
