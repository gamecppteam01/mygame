...
public:
	ResultCamera();
	void init();
	void start(const Vector3& nextTarget,const Vector3& add=Vector3::Zero, ResultEasingType xEase = ResultEasingType::Linear, ResultEasingType yEase = ResultEasingType::Linear, ResultEasingType zEase = ResultEasingType::Linear);
